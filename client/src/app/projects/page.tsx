...
export default function ClientsPage() {
  ...
  // Check if user is admin (hello.emprove)
  const isAdmin = user?.email === 'hello.emprove';
  ...
  const chartHeight = 200;
      ...
      return (
        <>
        <Head>
          <title>Clients | Maker's Schedule</title>
        </Head>
        {/* Header with Stats */}
        <div className="-mx-4 lg:-mx-6 -mt-4 lg:-mt-6 bg-brand-dark pt-4 pb-8 w-auto">
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex items-center justify-between mb-4">
              <div>
                <h1 className="text-2xl font-semibold text-white mb-2">Clients</h1>
